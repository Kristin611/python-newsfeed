...
class User(Base):
    ...
    # verify passowrd by decrypting it using the checkpw() method to compare the incoming pw (the password parameter) to the one saved on the User object (self.password)
